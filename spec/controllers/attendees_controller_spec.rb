  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested attendee" do
        ...
        expect(attendee.first_name).to eq(new_attributes[:first_name])
        expect(attendee.last_name).to eq(new_attributes[:last_name])
        expect(attendee.all_attendants).to eq(new_attributes[:all_attendants])
        expect(attendee.party_count).to eq(new_attributes[:party_count])
        expect(attendee.rsvp).to eq(new_attributes[:rsvp])
        expect(attendee.is_attending).to eq(new_attributes[:is_attending])
