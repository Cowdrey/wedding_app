...
RSpec.describe ApplicationController do
  ...
  #     mockBioTitle = 'mockBioTitle'
  #     mockJSONBioArr = [{:name => mockName, :imageUrl => mockImageUrl, :bioTitle => mockBioTitle, :bioText => mockBioText}]
  ...
  #     expect(bioResult.bioTitle).to eq(mockBioTitle)
  #   end
  # end
  #
